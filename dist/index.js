...
class MollierHxCard extends HTMLElement {
    ...
    // jobs
    doCheckConfig() {
        if (!this._config.temperature || !this._config.humidity || !this._config.entity) throw new Error('Please define a temperature and humidity entity!');
    }
    doStyle() {
...
},{"bundle-text:./card.html":"9f4sB","bundle-text:./card.css":"iniM4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9f4sB":[function(require,module,exports,__globalThis) {
module.exports = "<html><head></head><body><ha-card>\n    <div class=\"card-content\">\n        <p class=\"error error hidden\">\n        </p><dl class=\"dl\">\n            <dt class=\"dt\"></dt>\n            <dd class=\"dd\">\n                <span class=\"toggle\">\n                    <span class=\"button\"></span>\n                </span>\n                <span class=\"value\">\n                </span>\n            </dd>\n        </dl>\n    </div>\n</ha-card><script src=\"/mollier-hx-card.15c9597f.js\"></script></body></html>";

},{}],"iniM4":[function(require,module,exports,__globalThis) {
...
},{}]},["3VwnP","8lqZg"], "8lqZg", "parcelRequireaf85", {})
